...
#include <cassert>
#include <cstring>
// Check that leak detector can report multiple leaks.

int main() {
    char* ptrs[10];
    ptrs[0] = (char*) m61_malloc(10);
    ptrs[1] = (char*) m61_malloc(11);
    ptrs[2] = (char*) m61_malloc(12);
    ptrs[3] = (char*) m61_malloc(13);
    ptrs[4] = (char*) m61_malloc(14);
    ptrs[5] = (char*) m61_malloc(15);
    ptrs[6] = (char*) m61_malloc(16);
    ptrs[7] = (char*) m61_malloc(17);
    ptrs[8] = (char*) m61_malloc(18);
    ptrs[9] = (char*) m61_malloc(19);
